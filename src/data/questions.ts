...
export const SAMPLE_QUESTIONS: Question[] = [...NEW_QUESTIONS, ...NEW_QUESTIONS_2, ...NEW_QUESTIONS_3, ...NEW_QUESTIONS_4, ...NEW_QUESTIONS_5, ...NEW_QUESTIONS_6];

// 题库版本，更新时 LocalStorage 中的旧数据会被覆盖
export const QUESTION_BANK_VERSION = '10';
