...
// 读取题目文件
const content = fs.readFileSync('题库文件/题目4.txt', 'utf-8');
...
fs.writeFileSync('src/data/newQuestions4.ts', fullCode, 'utf-8');
console.log('第四套题库文件已生成: src/data/newQuestions4.ts');
